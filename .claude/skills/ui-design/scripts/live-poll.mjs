 ...
 *
 * Usage:
 *   node scripts/live-poll.mjs                         # Block until browser event, print JSON
 *   node scripts/live-poll.mjs --stream                # Experimental: keep polling; one JSON line per event
 *   node scripts/live-poll.mjs --timeout=600000        # Custom timeout (ms); default is long-poll friendly
 *   node scripts/live-poll.mjs --reply <id> done       # Reply "done" to event <id>

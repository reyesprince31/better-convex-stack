...
(function () {
  ...
  function checkTypography() {
    ...
    for (const el of document.querySelectorAll(
      ...
      if (el.closest && el.closest(".uizze-overlay, .uizze-label, .uizze-banner, .uizze-tooltip"))
        continue;
  ...
  if (IS_BROWSER) {
    ...
    const EXTENSION_MODE =
      (_myScript && _myScript.dataset.uizzeExtension === "true") ||
  ...
  `;
    ...
    document.addEventListener("transitionend", (e) => {
      ...
      for (const o of overlays) {
        if (!o._targetEl || o.classList.contains("uizze-banner") || o.style.display === "none")
          continue;
    ...
    function reportVisualContrastError(err, detail = {}) {
      window.dispatchEvent(
        new CustomEvent("uizze-visual-contrast-error", {
          detail: {
            ...detail,
            message: err?.message || String(err),
          },
            ...
            waitForVisualPaint()
              ...
              .then((result) => {
                ...
                if (added) {
                  ...
                  window.dispatchEvent(
                    new CustomEvent("uizze-visual-contrast-resolved", {
                      detail: {

...
**CRITICAL**: If no design system exists, Ask only when the answer cannot be inferred safely, then wait. before creating one. Understand the preferred location and structure first.

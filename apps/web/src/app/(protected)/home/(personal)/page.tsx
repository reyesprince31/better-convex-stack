  ...
  return (
    <div className="space-y-10">
      <section className="flex flex-col justify-between gap-5 border-b border-border/70 pb-8 sm:flex-row sm:items-end">
        <div>
          <p className="font-mono text-[10px] tracking-[0.18em] text-muted-foreground uppercase">{workspace.dateLabel}</p>
          <h1 className="mt-3 text-4xl font-medium tracking-[-0.06em] sm:text-5xl">{workspace.greeting}</h1>

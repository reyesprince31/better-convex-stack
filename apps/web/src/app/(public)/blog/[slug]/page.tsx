  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-5 pb-24 pt-16 sm:px-8 sm:pt-24">
      ...
      <article className="mx-auto mt-20 max-w-3xl">
        ...
        <h1 className="mt-6 text-5xl font-medium leading-[0.95] tracking-[-0.07em] sm:text-7xl">
          {post.title}
        </h1>
        ...
        <p className="mt-14 border-l-2 border-foreground pl-5 text-lg leading-8 text-foreground/80 sm:text-xl">
          {post.intro}
        </p>
...
function BlogPostLoading() {
  return (
    <main
      className="mx-auto w-full max-w-7xl px-5 pb-24 pt-16 sm:px-8 sm:pt-24"

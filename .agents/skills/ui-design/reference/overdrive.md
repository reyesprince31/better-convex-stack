...
2. **Ask only when the answer cannot be inferred safely, then wait.** to present these directions and get the user's pick before writing any code. Explain trade-offs (browser support, performance cost, complexity).

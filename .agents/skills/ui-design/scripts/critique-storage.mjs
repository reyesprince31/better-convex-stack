 ...
 *
 * Each run of /uizze critique writes a per-target snapshot to
 *   .uizze/critique/<timestamp>__<slug>.md
 * with a small YAML frontmatter carrying the score + P0/P1 counts.
 *
 * /uizze polish reads the latest matching snapshot at start as its
...
import { getCritiqueDir } from "./uizze-paths.mjs";
